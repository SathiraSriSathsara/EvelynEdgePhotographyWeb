...
//Application Title
define('APP_TITLE', 'Enforcers.lk Admin | Files');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Enforcers.lk">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://enforcers.lk" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://enforcers.lk" target="_blank" class="app-v-title"> Enforcers.lk</a></h3></p>
                        <p>Editor: Sathira Sri Sathsara</p>
                        <p>Mail Us: <a href="mailto:admin@enforcers.lk">admin@enforcers.lk</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://enforcers.lk" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://enforcers.lk" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://enforcers.lk" target="_blank" class="float-right text-muted">Powered by Enforcers.lk</a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://enforcers.lk" target="_blank" class="float-right text-muted">Powered by Enforcers.lk</a></div>
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <meta name="description" content="Enforcers.lk File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'ENFORCERS.LK';
